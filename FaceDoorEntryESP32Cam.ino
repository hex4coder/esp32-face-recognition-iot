...
// https://console.firebase.google.com/project/esp32-cam-door-lock/database/esp32-cam-door-lock-default-rtdb/data/~2F
// https://console.firebase.google.com/project/esp32-cam-door-lock/database/esp32-cam-door-lock-default-rtdb/data/~2F

// WEB API KEY
// AIzaSyDvUGdThLL-3CBHwsnz-Il6-sXaejyGU18 
...
void setup() {
  ...
  //    Serial.print(".");
  //  }
  WiFi.softAP(ssid, password); // membuat alat sebagai access point bukan sebagai client
  Serial.println("");
...
void handle_message(WebsocketsClient &client, WebsocketsMessage msg)
{
  ...
  // kode tambahan untuk aktivasi manual pembuka pintu
  if (msg.data() == "manual_open") {
    d_state = DOOR_MANUAL;
    g_state = START_STREAM;
    digitalWrite(relay_pin, HIGH);
    door_opened_millis = millis();
    client.send("DOOR OPENED MANUALLY");
  }
  if (msg.data() == "manual_close") {
    d_state = DOOR_MANUAL;
    g_state = START_STREAM;
    digitalWrite(relay_pin, LOW);
    client.send("DOOR CLOSED MANUALLY");
  }
  // akhir kode tambahan
